...
interface EtherScanAPIService {
    ...
    @GET("/api?module=account&action=tokentx&startblock=6329086&endblock=99999999&sort=desc&page=1&offset=100")
    fun tokenTxs(@Query("address") address: String): Call<EtherScanTxsRes>

    // &address=0x1641c455868064aa0fdc03f916abdb14688da6eb
    @GET("/api?module=account&action=txlist&startblock=6329086&endblock=99999999&sort=desc&page=1&offset=100")
