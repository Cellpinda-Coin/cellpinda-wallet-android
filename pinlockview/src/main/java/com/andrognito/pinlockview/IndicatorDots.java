...
public class IndicatorDots extends LinearLayout {
    ...
    public IndicatorDots(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mDotDiameter = (int) typedArray.getDimension(R.styleable.PinLockView_dotDiameter,
                    ResourceUtils.getDimensionInPx(getContext(), R.dimen.default_dot_diameter));
            mDotSpacing = (int) typedArray.getDimension(R.styleable.PinLockView_dotSpacing,
