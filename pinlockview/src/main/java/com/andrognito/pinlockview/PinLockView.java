...
public class PinLockView extends RecyclerView {
    ...
    private void init(AttributeSet attributeSet, int defStyle) {
        ...
        try {
            ...
            mTextColor = typedArray.getColor(R.styleable.PinLockView_keypadTextColor, ResourceUtils.getColor(getContext(), R.color.colorPrimaryAlpha));
            ...
            mDeleteButtonPressedColor = typedArray.getColor(R.styleable.PinLockView_keypadDeleteButtonPressedColor, ResourceUtils.getColor(getContext(), R.color.colorPrimaryAlpha));
        } finally {
            typedArray.recycle();
        }
